...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-huxtable-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-huxtable-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install r-huxtable
```
...
It is possible to list all of the versions of `r-huxtable` available on your platform:
...
```
pixi search r-huxtable --channel conda-forge
```
